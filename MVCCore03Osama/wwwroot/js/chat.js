...
function process(input) {
    var now = new Date();
    var path = ""
    if ($("input[name='userimage']").val() == "def.jfif") {
        path = "def.jfif"
    } else {
        path = $("input[name='useremail']").val() + "/" + $("input[name='userimage']").val()
    }
    ...
    var inp = `<div class="msg-container msg-remote" id="msg-0">
                    <div class="msg-box">
                        <img class="user-img" id="user-0" src="../../Images/${path}" />
                        <div class="flr">
                            <div class="messages">
                            ...
                            <span class="timestamp"><span class="username">${$("input[name='username']").val()}</span>&bull;<span class="posttime">${now.getHours() + ":" + now.getMinutes()}</span></span>
                        </div>
                    </div>
                </div>`
    ...
    function callback() {
        ...
        var out = `<div class="msg-container msg-self" id="msg-0">
                <div class="msg-box">
                    ...
                    <img class="user-img" id="user-0" src="../../Images/cartoon-robot-toy-object-for-small-children-to-vector-32859441.jpg" />
                </div>
            </div>`
        if (product == "Contact"){
            if (input == "help"){
...
function contactAdmin() {
    ...
    $.ajax({
        ...
        success: function (Data) {
            ...
            console.log(data)
            $('#input').val("")
            $.notify('Message Sended to Admin Successfuly', { globalPosition: 'top center', className: 'success' })
